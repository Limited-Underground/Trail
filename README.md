...
| Latest increment | Existing Android visual shell integrated with the current service-owned V1-Test recorder. Messages/Group/Device, mint theme, status strip, local drafts and support export are software-validated; combined APK not installed. See [integration evidence](tests/hardware/OT-171-177-VISUAL-INTEGRATION-2026-09-06.md). OLED/clock work precedes broader acceptance; cold-power and website updates remain deferred. |
