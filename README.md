...
Read [the architecture](docs/ARCHITECTURE.md), [project status and assumptions](docs/PROJECT_STATUS.md), [the hardware inventory](hardware/INVENTORY.md), [the Wio Tracker arrival plan](hardware/WIO_TRACKER_L1_PRO_BRINGUP.md), [the critical-alert v0 contract](docs/integration/OPENGAUGE_CRITICAL_ALERT_V0.md), [the mirrored critical-alert ACK contract](docs/integration/OPENGAUGE_CRITICAL_ALERT_ACK_V0.md), [the ACK responder policy](docs/integration/CRITICAL_ALERT_ACK_RESPONDER_V0.md), [the responder boot-session store](docs/persistence/ACK_RESPONDER_SESSION_STORE_V0.md), [the identity/group threat model](docs/security/THREAT_MODEL_V0.md), [the group lifecycle and recovery UX](docs/security/GROUP_LIFECYCLE_V0.md), [the persistent-configuration envelope](docs/persistence/PERSISTENT_CONFIGURATION_V0.md), [the packet envelope](docs/protocol/EXPERIMENTAL_PACKET_V0.md), [the experimental delivery policy](docs/protocol/DELIVERY_POLICY_V0.md), [the duplicate-checkpoint codec](docs/protocol/DUPLICATE_CHECKPOINT_CODEC_V0.md), [the controlled-forwarding policy](docs/protocol/FORWARDING_POLICY_V0.md), [the GPS/location abstraction](docs/location/GPS_ABSTRACTION.md), [the position-broadcast format and budget](docs/protocol/POSITION_BROADCAST_V0.md), [the diagnostics foundation](docs/DIAGNOSTICS.md), [the repeater proof](tests/hardware/OT-009-2026-08-08.md), and [the backlog](tasks/BACKLOG.md). OT-017, OT-017A, OT-017B, and OT-017C are complete for their bounded semantic/host scopes. Hardware identity, cryptography, physical alert transport, secret storage, and regulatory questions continue in parallel.
