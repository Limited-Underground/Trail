...
| Latest increment | Reviewed [OLED configuration/time authority contract](docs/platform/OLED_CONFIGURATION_TIME_AUTHORITY_V1.md). No new transport or hardware claim. Next: host time-admission owner. Prior OLED adapter passed local validation and reproducible builds; it remains uninstalled. Website/cold-power work stay deferred. |
