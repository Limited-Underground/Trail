...
| Latest increment | OT-120 accepts reproducible retained import/build evidence for libsodium, mbedTLS/PSA, and Monocypher. Counts are now `3/3/3`; Phase 0 and Phase 1 are complete, and measurement remains blocked only by absent fresh benchmark execution authority. No benchmark, device, radio, selection, support, compatibility, regulatory, or score claim changes |
