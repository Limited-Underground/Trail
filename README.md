...
| Latest increment | OT-148 independently reconciles the accepted OT-005 crypto evidence against the frozen OT-116 plan. Libsodium 1.0.22 is the only structurally selection-eligible candidate and is recorded as the evidence-backed recommendation, not a selection. Phase 2 remains incomplete pending mbedTLS/PSA measurement, matched linked-flash/static-RAM results, Noise XK radio cost, eight-gate reconciliation, and private trace-custody verification; Phase 3 and all cryptographic/wire selections remain withheld. No score change: V1 remains exact 43.75%/displayed 44%. |
