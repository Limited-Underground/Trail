...
| Latest increment | OT-149 prepares and host-validates the missing five-operation mbedTLS/PSA comparison target, strict 1,015-frame parser, matched no-candidate control, and signed/zero-capable linked-flash/static-RAM accounting successor. Fresh complete ESP32-S3 candidate/control builds pass with identical successor sdkconfig bytes. No benchmark, matched-resource result, hardware, radio, selection, Phase 2 completion, or score change is claimed; V1 remains exact 43.75%/displayed 44%. |
