...
| Latest increment | OT-123 prepares the exact Monocypher 5-of-8 comparison image, reproducible build evidence, parser, and recovery-safe two-node runner without accessing hardware. The matched control, physical execution, resource deltas, other candidate/radio measurements, Phase 3, and selection remain open; no support, compatibility, regulatory, production, or score claim changes |
