...
| Latest increment | [Privacy-safe optional-archive presentation](docs/location/BREADCRUMB_ARCHIVE_PRESENTATION_V0.md): stopped/active/queued/waiting/full/failed semantic states with no coordinates or operator actions |
| Proven so far | A 94-executable C++ host matrix plus Python evidence checks; two Heltec clients and one SenseCAP repeater have completed limited transport, soak, burst, and alert/acknowledgement tests |
