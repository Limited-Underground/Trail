...
| Latest increment | [Privacy-safe Windows loader inspection](tests/hardware/OT-019D-2026-08-12.md): read-only discovery plus strict runtime queries identify two Heltec companions and one SenseCAP repeater while omitting persistent identity and keeping Flash blocked |
