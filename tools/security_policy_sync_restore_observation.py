"""OT-201 image-bound restoration observation seam; no import-time device I/O.

The separately source-bound OT-201 execution package owns exact candidate and
...
import security_policy_sync_observation as projection
...
"""
        ...
        execution.need(events and events[-1] == "restore_intent" and
                       ...
                       "diagnostic_boundary_unavailable")
        name = f"ot201-sync-{self.role}-{journal.owner['attempt']}.bin"
