#!/usr/bin/env python3
"""Restoration-safe OT-136 two-node Monocypher execution coordinator.
...
JOURNAL_PATH = PRIVATE_ROOT / "ot136-monocypher-execution-journal.json"
EXECUTION_RECEIPT_PATH = PRIVATE_ROOT / "ot136-monocypher-execution-receipt.json"
RECOVERY_RECEIPT_PATH = PRIVATE_ROOT / "ot136-monocypher-recovery-receipt.json"
...
def _private_paths_valid() -> bool:
    expected = {
        JOURNAL_PATH: "ot136-monocypher-execution-journal.json",
        EXECUTION_RECEIPT_PATH: "ot136-monocypher-execution-receipt.json",
        RECOVERY_RECEIPT_PATH: "ot136-monocypher-recovery-receipt.json",
    }
