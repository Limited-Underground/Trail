#!/usr/bin/env python3
"""Build and validate the host-only OT-140 executable Monocypher authority.

This tool performs canonical file validation only.  It has no serial, esptool,
subprocess, device-discovery, flash, capture, or reset surface.  OT-140 binds
the accepted OT-139 quiet-target tuple after OT-136 consumed its one attempt
on the recorded OT-137 abort.  No attempt or continuing authority is inherited.
"""
...
PREPARATION_RELATIVE = (
    ...
    "OT-140-OT005-MONOCYPHER-EXECUTABLE-BUNDLE-PREPARATION-V0.json"
)
AUTHORITY_RELATIVE = (
    "tests/benchmarks/crypto/"
...
CONTRACT_TOOL_RELATIVE = "tools/ot140_monocypher_execution_authority.py"

PREPARATION_SCHEMA = "OT140MEBP0"
PREPARATION_ID = (
    "OT-140-OT005-MONOCYPHER-EXECUTABLE-BUNDLE-PREPARATION-V0"
)
AUTHORITY_SCHEMA = "OT140MOAA0"
AUTHORITY_ID = "OT-140-OT005-MONOCYPHER-ONE-ATTEMPT-AUTHORITY-V0"
...
OT139_DECISION_RELATIVE = (
    "docs/decisions/0078-accept-reproducible-monocypher-quiet-target.md"
)
OT139_DECISION_RAW_SHA256 = (
    "9f75b8059580f8b7a70d960778df43f9bdf18160dd777d8152de4dadae5b6998"
)
OT139_EVIDENCE_RELATIVE = "tests/hardware/OT-139-2026-08-25.md"
OT139_EVIDENCE_RAW_SHA256 = (
    "b21122026af9e12bd1b6db408b1b3e0d2977ca86a1d2346fcfb0723a1fcb8a95"
)
OT139_BUILD_EVIDENCE_RELATIVE = (
    "tests/benchmarks/crypto/"
    "OT-139-OT005-MONOCYPHER-QUIET-TARGET-BUILD-EVIDENCE-V0.json"
)
OT139_BUILD_EVIDENCE_RAW_SHA256 = (
    "1a1aa548ed6487a56529e6b75cee253f707e35926b69b6d1e1effcc47287561d"
)
OT139_ESP_IDF_COMMIT = "7101770dc6db2667b3c477cc31365dd1acd6db4e"

OT139_ARTIFACT_TUPLE: tuple[tuple[str, str, int, str], ...] = (
...
FIXED_RUNTIME_BINDINGS: tuple[tuple[str, str, str], ...] = (
    (
        "coordinator",
        "tools/ot140_monocypher_coordinator.py",
...
def _artifact_tuple_descriptor(
    ...
    if required:
        ...
        for _, name, size, digest in OT139_ARTIFACT_TUPLE:
    ...
    return [
        ...
        for role, name, size, digest in OT139_ARTIFACT_TUPLE
    ]
...
def _execution_contract() -> dict[str, Any]:
    return {
        ...
        "adapter_invokes_frozen_ot140_coordinator_only": True,
...
def _build_preparation(
    ...
    *,
    ...
    return {
        ...
        "supersession": {
            "reason": "ot136_consumed_on_ot137_abort_ot139_successor_accepted",
            "ot136_authority_consumed": True,
            "ot136_authority_reusable": False,
            "replacement_attempt_inherited": False,
            "ot136_authority": _fixed_binding(
                OT136_AUTHORITY_RELATIVE, OT136_AUTHORITY_RAW_SHA256
            ),
            "ot137_abort": _fixed_binding(
                OT137_ABORT_RELATIVE, OT137_ABORT_RAW_SHA256
            ),
            "ot139_decision": _fixed_binding(
                OT139_DECISION_RELATIVE, OT139_DECISION_RAW_SHA256
            ),
            "ot139_evidence": _fixed_binding(
                OT139_EVIDENCE_RELATIVE, OT139_EVIDENCE_RAW_SHA256
            ),
            "ot139_build_evidence": _fixed_binding(
                OT139_BUILD_EVIDENCE_RELATIVE, OT139_BUILD_EVIDENCE_RAW_SHA256
            ),
        },
        "candidate": {
            "id": "monocypher",
        ...
        "runtime": runtime,
        "quiet_target": {
            "esp_idf_commit": OT139_ESP_IDF_COMMIT,
        ...
        "private_artifacts": {
            "journal": "new_fixed_ot140_private_path_not_published",
            "execution_receipt": "new_fixed_ot140_private_path_not_published",
            "recovery_receipt": "new_fixed_ot140_private_path_not_published",
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print("ERROR: OT-140 executable bundle/authority validation failed")
        return 2
