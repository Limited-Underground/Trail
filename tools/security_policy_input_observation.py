"""OT-198 restoration observation seam, not an executable trial/operator.

A future source-bound successor must admit fresh originals, this diagnostic image
and its additional NVS writes/read before invoking this seam. OT-188/192/196 grants
...
"""
        ...
        execution.need(events and events[-1] == "restore_intent" and
                       ...
                       "diagnostic_boundary_unavailable")
        name = f"ot198-input-{self.role}-{journal.owner['attempt']}.bin"
