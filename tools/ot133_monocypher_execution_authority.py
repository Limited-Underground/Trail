#!/usr/bin/env python3
"""Build and validate the host-only OT-133 executable Monocypher authority.

This tool performs canonical file validation only.  It has no serial, esptool,
subprocess, device-discovery, flash, capture, or reset surface.  OT-133 binds
the OT-132 protocol successor after OT-131 consumed its one attempt on abort.
...
PREPARATION_RELATIVE = (
    ...
    "OT-133-OT005-MONOCYPHER-EXECUTABLE-BUNDLE-PREPARATION-V0.json"
)
AUTHORITY_RELATIVE = (
    "tests/benchmarks/crypto/"
    "OT-133-OT005-MONOCYPHER-ONE-ATTEMPT-AUTHORITY-V0.json"
)
ADAPTER_RELATIVE = "tools/ot133_monocypher_hardware_adapter.py"
CONTRACT_TOOL_RELATIVE = "tools/ot133_monocypher_execution_authority.py"

PREPARATION_SCHEMA = "OT133MEBP0"
PREPARATION_ID = (
    "OT-133-OT005-MONOCYPHER-EXECUTABLE-BUNDLE-PREPARATION-V0"
)
AUTHORITY_SCHEMA = "OT133MOAA0"
AUTHORITY_ID = "OT-133-OT005-MONOCYPHER-ONE-ATTEMPT-AUTHORITY-V0"
...
OT131_AUTHORITY_RELATIVE = (
    "tests/benchmarks/crypto/"
    "OT-131-OT005-MONOCYPHER-ONE-ATTEMPT-AUTHORITY-V0.json"
)
OT131_AUTHORITY_RAW_SHA256 = (
    "c134107cf98c75045e033cb087b58dce9e693e77542e1e70406a8896a2532eb9"
)
OT131_ABORT_RELATIVE = (
    "tests/benchmarks/crypto/"
    "OT-131-OT005-MONOCYPHER-EXECUTION-ABORT-RECEIPT-V0.json"
)
OT131_ABORT_RAW_SHA256 = (
    "4557149d6a45fb12bddeea968edea6f9d5ace76edf9d4203f13cf79711a6f489"
)
OT132_DECISION_RELATIVE = (
    "docs/decisions/0071-host-only-monocypher-opaque-preamble-correction.md"
)
OT132_DECISION_RAW_SHA256 = (
    "ed86f244673d5ded814fb1c2a1d392b52a311977897378b854476c0ae319b23e"
)
OT132_EVIDENCE_RELATIVE = "tests/hardware/OT-132-2026-08-24.md"
OT132_EVIDENCE_RAW_SHA256 = (
    "2f7ee064f55446c33556c168e14dadb3ee7c023616b5860b796c62b048540b59"
)

FIXED_RUNTIME_BINDINGS: tuple[tuple[str, str, str], ...] = (
    (
        "coordinator",
        "tools/ot133_monocypher_coordinator.py",
        "04d050d540f49203f2d041cb87dfa4f0d8f741aa268d43b75866ce67a4458cff",
    ),
    (
        "protocol_transport",
        "tools/ot132_monocypher_protocol_runner.py",
...
def _execution_contract() -> dict[str, Any]:
    return {
        ...
        "adapter_invokes_frozen_ot133_coordinator_only": True,
...
def _build_preparation(
    ...
    *,
    ...
    return {
        ...
        "supersession": {
            "reason": "ot131_consumed_on_abort_ot132_successor_accepted",
            "ot131_authority_consumed": True,
            "ot131_authority_reusable": False,
            "replacement_attempt_inherited": False,
            "ot131_authority": _fixed_binding(
                OT131_AUTHORITY_RELATIVE, OT131_AUTHORITY_RAW_SHA256
            ),
            "ot131_abort": _fixed_binding(
                OT131_ABORT_RELATIVE, OT131_ABORT_RAW_SHA256
            ),
            "ot132_decision": _fixed_binding(
                OT132_DECISION_RELATIVE, OT132_DECISION_RAW_SHA256
            ),
            "ot132_evidence": _fixed_binding(
                OT132_EVIDENCE_RELATIVE, OT132_EVIDENCE_RAW_SHA256
            ),
        },
        "candidate": {
            "id": "monocypher",
        ...
        "private_artifacts": {
            "journal": "new_fixed_ot133_private_path_not_published",
            "execution_receipt": "new_fixed_ot133_private_path_not_published",
            "recovery_receipt": "new_fixed_ot133_private_path_not_published",
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print("ERROR: OT-133 executable bundle/authority validation failed")
        return 2
