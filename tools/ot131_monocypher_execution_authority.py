#!/usr/bin/env python3
"""Build and validate the host-only OT-131 executable Monocypher authority.

This tool performs canonical file validation only.  It has no serial, esptool,
subprocess, device-discovery, flash, capture, or reset surface.  OT-131 replaces
the unexecuted OT-130 authority because OT-130 did not bind a concrete hardware
adapter.  The replacement does not claim that OT-130 was consumed.
"""
...
PREPARATION_RELATIVE = (
    ...
    "OT-131-OT005-MONOCYPHER-EXECUTABLE-BUNDLE-PREPARATION-V0.json"
)
AUTHORITY_RELATIVE = (
    "tests/benchmarks/crypto/"
...
CONTRACT_TOOL_RELATIVE = "tools/ot131_monocypher_execution_authority.py"

PREPARATION_SCHEMA = "OT131MEBP0"
PREPARATION_ID = (
    "OT-131-OT005-MONOCYPHER-EXECUTABLE-BUNDLE-PREPARATION-V0"
)
AUTHORITY_SCHEMA = "OT131MOAA0"
AUTHORITY_ID = "OT-131-OT005-MONOCYPHER-ONE-ATTEMPT-AUTHORITY-V0"
...
OT130_PREPARATION_RELATIVE = (
    "tests/benchmarks/crypto/"
    "OT-130-OT005-MONOCYPHER-IMMUTABLE-EXECUTION-BUNDLE-PREPARATION-V0.json"
)
OT130_PREPARATION_RAW_SHA256 = (
    "cc1d88aa9f5e45c3b13a1f229b767fcbf8e7dd383a75309e335f5397ddc780f7"
)
OT130_AUTHORITY_RELATIVE = (
    "tests/benchmarks/crypto/"
    "OT-130-OT005-MONOCYPHER-ONE-ATTEMPT-AUTHORITY-V0.json"
)
OT130_AUTHORITY_RAW_SHA256 = (
    "278ace6ce442a5c5b9ff5baa525c7e647798ebeff45a2f376bff67c762b6cdb9"
)

FIXED_RUNTIME_BINDINGS: tuple[tuple[str, str, str], ...] = (
    (
        "coordinator",
        "tools/ot130_monocypher_coordinator.py",
        "5487fd1ef7a8fffcd53a1fdc8d8d81b9459c127fcff2d4dd4c9ea8804431e8b0",
    ),
    (
        "protocol_transport",
...
def _execution_contract() -> dict[str, Any]:
    return {
        ...
        "adapter_invokes_frozen_ot130_coordinator_only": True,
...
def _build_preparation(
    ...
    *,
    ...
    return {
        ...
        "supersession": {
            "reason": "ot130_missing_concrete_authority_gate_and_device_backend",
            "ot130_authority_consumed": False,
            "ot130_authority_superseded_unexecuted": True,
            "replacement_attempt_inherited": False,
            "ot130_preparation": _fixed_binding(
                OT130_PREPARATION_RELATIVE, OT130_PREPARATION_RAW_SHA256
            ),
            "ot130_authority": _fixed_binding(
                OT130_AUTHORITY_RELATIVE, OT130_AUTHORITY_RAW_SHA256
            ),
        },
        "candidate": {
            "id": "monocypher",
        ...
        "private_artifacts": {
            "journal": "existing_fixed_ot130_private_path_not_published",
            "execution_receipt": "existing_fixed_ot130_private_path_not_published",
            "recovery_receipt": "existing_fixed_ot130_private_path_not_published",
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print("ERROR: OT-131 executable bundle/authority validation failed")
        return 2
