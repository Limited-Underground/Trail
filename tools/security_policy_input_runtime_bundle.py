"""Build and verify a private isolated OT-198 runtime; never launch it or access devices."""
...
SCHEMA = "OT198-INPUT-RUNTIME-1"
PTH = b"Lib\nDLLs\npackages\npolicy\n"
ESPTOOL_CONFIG = b"[esptool]\n"
POLICY = tuple("security_policy_" + name + ".py" for name in
               ("bundle", "hardware", "endpoint", "execution", "capture", "operator", "backup", "backup_operator", "diagnostics", "runtime_bundle", "input_bundle", "input_execution", "input_operator", "input_backup_operator", "input_runtime_bundle", "input_readback", "input_observation", "input_timing")) + ("Invoke-SecurityPolicyOperator.ps1", "Invoke-SecurityPolicyInputOperator.ps1")
