"""Build and verify a private isolated OT-196 runtime; never launch it or access devices."""
...
SCHEMA = "OT196-STAGE-RUNTIME-1"
PTH = b"Lib\nDLLs\npackages\npolicy\n"
ESPTOOL_CONFIG = b"[esptool]\n"
POLICY = tuple("security_policy_" + name + ".py" for name in
               ("bundle", "hardware", "endpoint", "execution", "capture", "operator", "backup", "backup_operator", "diagnostics", "runtime_bundle", "stage_bundle", "stage_execution", "stage_operator", "stage_backup_operator", "stage_runtime_bundle", "stage_readback", "stage_observation")) + ("Invoke-SecurityPolicyOperator.ps1", "Invoke-SecurityPolicyStageOperator.ps1")
