"""OT-203 image-bound restoration observation seam; no import-time device I/O.

The separately source-bound OT-203 execution package owns exact candidate and
runtime admission, fresh original custody and the single subordinate NVS-read
claim. Old grants and operators cannot authorize this image or observation.
"""
import hashlib
import os
...
import security_policy_receipt_observation as projection
...
"""
        ...
        execution.need(events and events[-1] == "restore_intent" and
                       ...
                       "diagnostic_boundary_unavailable")
        name = f"ot203-receipt-{self.role}-{journal.owner['attempt']}.bin"
