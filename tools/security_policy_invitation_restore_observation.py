"""OT-210 image-bound restoration observation seam; no import-time device I/O.

The separately source-bound OT-210 execution package owns exact candidate and
...
"""
        ...
        execution.need(events and events[-1] == "restore_intent" and
                       ...
                       "diagnostic_boundary_unavailable")
        name = f"ot210-invitation-{self.role}-{journal.owner['attempt']}.bin"
