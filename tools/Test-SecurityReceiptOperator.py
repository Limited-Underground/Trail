"""Complete affected OT-203 host matrix; synthetic devices and local files only."""
import argparse
...
SUITES = [
    'security_policy_receipt_bundle_tests.py',
    'security_policy_receipt_restore_observation_tests.py',
    'security_policy_receipt_execution_tests.py',
    'security_policy_receipt_runtime_bundle_tests.py',
    'security_policy_receipt_operator_tests.py',
    'security_policy_receipt_operator_integration_tests.py',
    'security_policy_receipt_isolated_tests.py',
...
def main():
    ...
    output = ROOT/'.private/ot203-operator/matrix'/stamp
    ...
    try:
        ...
        sources = [*bundle.SOURCE_PATHS, *('tests/host/'+name for name in SUITES),
                   'tools/Test-SecurityReceiptOperator.py', bundle.REPORT]
        ...
        if args.candidate is not None:
            for label, command in commands:
                if label == 'security_policy_receipt_operator_integration_tests':
