#!/usr/bin/env python3
"""Build and validate the host-only OT-144 Monocypher execution contract.

This tool performs canonical file validation only.  It has no serial, esptool,
subprocess, device-discovery, flash, capture, or reset surface.  OT-144 binds
the accepted OT-142 corrected target after the OT-143 coordinator mismatch was
detected before device I/O.  OT-143 remains unconsumed but is unexecutable and
nonreusable.  No attempt or continuing authority is inherited,
...
PREPARATION_RELATIVE = (
    ...
    "OT-144-OT005-MONOCYPHER-EXECUTABLE-BUNDLE-PREPARATION-V0.json"
)
AUTHORITY_RELATIVE = (
    "tests/benchmarks/crypto/"
    "OT-144-OT005-MONOCYPHER-ONE-ATTEMPT-AUTHORITY-V0.json"
)
ADAPTER_RELATIVE = "tools/ot144_monocypher_hardware_adapter.py"
CONTRACT_TOOL_RELATIVE = "tools/ot144_monocypher_execution_authority.py"

PREPARATION_SCHEMA = "OT144MEBP0"
PREPARATION_ID = (
    "OT-144-OT005-MONOCYPHER-EXECUTABLE-BUNDLE-PREPARATION-V0"
)
AUTHORITY_SCHEMA = "OT144MOAA0"
AUTHORITY_ID = "OT-144-OT005-MONOCYPHER-ONE-ATTEMPT-AUTHORITY-V0"
...
def _execution_contract() -> dict[str, Any]:
    return {
        ...
        "adapter_invokes_frozen_ot144_coordinator_only": True,
...
def _build_preparation(
    ...
    *,
    ...
    return {
        ...
        "supersession": {
            "reason": "coordinator_binding_mismatch_detected_before_device_io",
            "ot143_authority_consumed": False,
            "ot143_authority_executable": False,
            "ot143_authority_reusable": False,
            "replacement_attempt_inherited": False,
            "ot143_hardware_io_occurred": False,
            "ot143_authority": _fixed_binding(
                OT143_AUTHORITY_RELATIVE, OT143_AUTHORITY_RAW_SHA256
            ),
            "ot143_terminal_boundary": "unconsumed_unexecutable_before_device_io",
        },
        ...
        "private_artifacts": {
            "journal": "new_fixed_ot144_private_path_not_published",
            "execution_receipt": "new_fixed_ot144_private_path_not_published",
            "recovery_receipt": "new_fixed_ot144_private_path_not_published",
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print("ERROR: OT-144 executable bundle/authority validation failed")
        return 2
