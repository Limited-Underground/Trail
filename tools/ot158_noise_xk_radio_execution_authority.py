#!/usr/bin/env python3
"""Create and validate the host-only OT-158 one-attempt radio authority.

This tool has no endpoint, serial, flash, reset, radio, execution, or recovery
surface.  It binds the accepted OT-157 reset-aware executable/restoration
...
ADAPTER_RELATIVE = "tools/ot157_noise_xk_radio_hardware_adapter.py"
AUTHORITY_TOOL_RELATIVE = "tools/ot158_noise_xk_radio_execution_authority.py"

PREPARATION_SCHEMA = "OT157NXBP0"
PREPARATION_ID = (
    "OT-157-OT005-LIBSODIUM-NOISE-XK-RADIO-EXECUTABLE-BUNDLE-PREPARATION-V0"
)
PREPARATION_RAW_SHA256 = (
    "889bb6440f71864f29e815be926fbcc6c04d2de442be3cf38b6a2eceb365ba2a"
)
PREPARATION_CANONICAL_SHA256 = (
    "28a358393e3f9edaf8b9e155283737b087b5c0e43206598ba540cc5882caf25f"
)
PARENT_RELATIVE = (
    "tests/benchmarks/crypto/"
...
AUTHORITY_SCHEMA = "OT158NXRA0"
AUTHORITY_ID = (
    "OT-158-OT005-LIBSODIUM-NOISE-XK-RADIO-ONE-ATTEMPT-AUTHORITY-V0"
)
...
RUNTIME_BINDINGS = {
    ...
    "coordinator": {
        "path": "tools/ot157_noise_xk_radio_coordinator.py",
        "bytes": 6986,
        "raw_sha256": "a17d4615a50d2e373ba7fab98b6bed160e6b24e291aac2ec83f0fa19d1479db1",
    },
    "hardware_adapter": {
        "path": ADAPTER_RELATIVE,
        "bytes": 3935,
        "raw_sha256": "ec744f7430627600de1491d5729d8b5874ac38977faa786df90a4d39ce2d3de8",
    },
}
BENCHMARK = {
...
def main(argv: list[str] | None = None) -> int:
    try:
        ...
        print("ERROR: OT-158 execution authority validation failed", file=sys.stderr)
        return 2
