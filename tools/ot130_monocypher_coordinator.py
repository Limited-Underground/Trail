#!/usr/bin/env python3
"""Restoration-safe OT-130 two-node Monocypher execution coordinator.
...
JOURNAL_PATH = PRIVATE_ROOT / "ot130-monocypher-execution-journal.json"
EXECUTION_RECEIPT_PATH = PRIVATE_ROOT / "ot130-monocypher-execution-receipt.json"
RECOVERY_RECEIPT_PATH = PRIVATE_ROOT / "ot130-monocypher-recovery-receipt.json"
...
BAUD = 115_200
JOURNAL_SCHEMA = "OT130MCJ0"
RECEIPT_SCHEMA = "OT130MCR0"
HASH64 = re.compile(r"^[0-9a-f]{64}$")

_PROTOCOL_PATH = ROOT / "tools" / "ot129_monocypher_protocol_runner.py"
_PROTOCOL_SPEC = importlib.util.spec_from_file_location(
    "_ot130_ot129_protocol", _PROTOCOL_PATH
)
...
def _private_paths_valid() -> bool:
    expected = {
        JOURNAL_PATH: "ot130-monocypher-execution-journal.json",
        EXECUTION_RECEIPT_PATH: "ot130-monocypher-execution-receipt.json",
        RECOVERY_RECEIPT_PATH: "ot130-monocypher-recovery-receipt.json",
    }
