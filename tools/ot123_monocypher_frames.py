#!/usr/bin/env python3
"""Strict host-only parser for OT-123 Monocypher comparison frames."""
...
PHASES = ("cold", "warm")
GATES = ("primitive_vectors_and_negative_cases",)
REPETITIONS = 100
...
def _sample(
    ...
    return _integer(record["duration_us"], "sample duration", 1, MAX_DURATION_US)
