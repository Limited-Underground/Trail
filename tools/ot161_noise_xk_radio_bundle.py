#!/usr/bin/env python3
"""Build and validate the host-only OT-161 corrected radio bundle.

The tool has no execution or persistence surface. It binds the accepted
OT-153 firmware/build/restoration evidence to the accepted OT-156 runner
and runtime plus the exact OT-160 corrected coordinator and adapter. Every
authority flag remains false until a separately accepted OT-162 authority
exists.
"""
...
EXPECTED_RECORD_RAW_SHA256 = "942f7bda82273e8d06901827934eac6dc2c30ac3135ba614c2067eecb8cb171c"
EXPECTED_RECORD_CANONICAL_SHA256 = "0364615ab9d1129f4b3d83e0ea34d66da0b6e4a8a3070646d277984881388e9f"
...
RUNTIME_BINDINGS = (
    ...
    ("hardware_adapter", "tools/ot160_noise_xk_radio_hardware_adapter.py"),
)
RUNTIME_SHA256 = {
    ...
    "coordinator": "444528fd341b3d55f3a5b3224b217620e1b37e3c7960d224aefbe01d9953a02d",
    "hardware_adapter": "24d75806cdf7ae28c47fe427cac12a7ef3564d76d68a926ad58bd610c9e8f4b9",
}
BUILD_ARTIFACTS = (
...
class ContractError(ValueError):
    """Stable privacy-safe OT-161 preparation failure."""
...
def build_preparation(
    ...
    """Generate the deterministic immutable OT-161 host-only preparation."""
