"""Build and verify a private isolated OT-201 runtime; never launch it or access devices."""
...
SCHEMA = "OT201-SYNC-RUNTIME-1"
PTH = b"Lib\nDLLs\npackages\npolicy\n"
ESPTOOL_CONFIG = b"[esptool]\n"
POLICY = tuple("security_policy_" + name + ".py" for name in
               ('bundle','hardware','endpoint','execution','capture','operator','backup','backup_operator','diagnostics','runtime_bundle','input_readback','input_timing','sync_readback','sync_observation','sync_bundle','sync_execution','sync_operator','sync_backup_operator','sync_runtime_bundle','sync_restore_observation')) + ("Invoke-SecurityPolicyOperator.ps1", "Invoke-SecurityPolicySyncOperator.ps1")
