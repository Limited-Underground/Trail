#!/usr/bin/env python3
"""OT-135 byte-bounded opaque-preamble START/READY transport.
...
# Every complete record consumes at least its newline byte; this byte budget also bounds record count.
