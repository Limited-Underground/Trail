"""Build and verify a private isolated OT-212 runtime; never launch it or access devices."""
...
SCHEMA = "OT212-DEADLINE-RUNTIME-1"
PTH = b"Lib\nDLLs\npackages\npolicy\n"
ESPTOOL_CONFIG = b"[esptool]\n"
POLICY = ('security_policy_bundle.py', 'security_policy_hardware.py', 'security_policy_endpoint.py', 'security_policy_execution.py', 'security_policy_capture.py', 'security_policy_operator.py', 'security_policy_backup.py', 'security_policy_backup_operator.py', 'security_policy_diagnostics.py', 'security_policy_runtime_bundle.py', 'security_policy_input_readback.py', 'security_policy_input_timing.py', 'security_policy_invitation_readback.py', 'security_policy_invitation_observation.py', 'security_policy_deadline_bundle.py', 'security_policy_deadline_execution.py', 'security_policy_deadline_operator.py', 'security_policy_deadline_backup_operator.py', 'security_policy_deadline_runtime_bundle.py', 'security_policy_deadline_restore_observation.py', 'security_policy_receipt_boundary.py', 'security_policy_deadline_endpoint.py', 'security_policy_deadline_boundary.py', 'Invoke-SecurityPolicyOperator.ps1', 'Invoke-SecurityPolicyDeadlineOperator.ps1')
