"""Private, read-only package binding for OT-198. No ports, CLI or authority issuance."""
...
SCHEMA = "OT198-INPUT-BUNDLE-1"
BUILD_SOURCE_COUNT = 41
CANDIDATE_SIZE = 438912
CANDIDATE_SHA = "5fc90c0d4c5f096227b4e1e33caed1ef8079ef515f1f04884074447464c25b6f"
REPORT = "tests/benchmarks/crypto/OT-198-INPUT-DIAGNOSTICS-BUILD-2026-09-11.json"
REPORT_SHA = "dbc9292229499dc6fe4d5320e9187ec81e1a2f0c6180272f7135a8010fe0fe69"
...
SOURCE_PATHS = tuple("tools/security_policy_" + name + ".py" for name in
                     ("bundle", "hardware", "endpoint", "execution", "capture", "operator", "backup", "backup_operator", "diagnostics", "runtime_bundle", "input_bundle", "input_execution", "input_operator", "input_backup_operator", "input_runtime_bundle", "input_readback", "input_observation", "input_timing")) + ("tools/Invoke-SecurityPolicyInputOperator.ps1", "tools/Invoke-SecurityPolicyOperator.ps1")
...
SCOPE = {"version": "ot187-policy-v0", "radio": False, "application_offset": 65536,
         "application_span": 589824, "nvs_offset": 53248, "nvs_span": 12288, "image_version": "ot198-input-diag-v0",
         "diagnostic_namespace": "ot198diag", "diagnostic_key": "stage",
