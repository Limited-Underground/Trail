#!/usr/bin/env python3
"""Restoration-safe OT-133 two-node Monocypher execution coordinator.
...
JOURNAL_PATH = PRIVATE_ROOT / "ot133-monocypher-execution-journal.json"
EXECUTION_RECEIPT_PATH = PRIVATE_ROOT / "ot133-monocypher-execution-receipt.json"
RECOVERY_RECEIPT_PATH = PRIVATE_ROOT / "ot133-monocypher-recovery-receipt.json"
...
BAUD = 115_200
JOURNAL_SCHEMA = "OT133MCJ0"
RECEIPT_SCHEMA = "OT133MCR0"
HASH64 = re.compile(r"^[0-9a-f]{64}$")

_PROTOCOL_PATH = ROOT / "tools" / "ot132_monocypher_protocol_runner.py"
_PROTOCOL_SPEC = importlib.util.spec_from_file_location(
    "_ot133_ot132_protocol", _PROTOCOL_PATH
)
...
def _private_paths_valid() -> bool:
    expected = {
        JOURNAL_PATH: "ot133-monocypher-execution-journal.json",
        EXECUTION_RECEIPT_PATH: "ot133-monocypher-execution-receipt.json",
        RECOVERY_RECEIPT_PATH: "ot133-monocypher-recovery-receipt.json",
    }
