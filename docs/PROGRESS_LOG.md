...
- Ten menu groups and the now-thirteen-group local-interface suite pass 100/100
  focused repeats and the complete 107-executable matrix. Parent-shell,
...
- Ten groups plus 100/100 focused repeats cover the independent canonical
  ...
  and corruption at every byte. The complete 107-executable matrix passes.
...
- Nine groups plus 100/100 focused repeats and the complete 107-executable host
...
- Eight groups plus 100/100 focused repeats and the complete 107-executable
...
- Eight bootstrap groups plus 100/100 focused repeats and the complete
  107-executable host matrix pass. Exact target backend/seed composition,
...
- Nine store groups, five real key/value-composition groups, the eleven-group
  consent suite, 100/100 focused repeats, and the complete 107-executable host
...
- Fourteen deterministic groups plus 100/100 focused repeats and the complete
  107-executable host matrix pass. The workflow now requires explicit durable
...
- Eleven deterministic groups plus 100/100 focused repeats pass within the
  current 107-executable host matrix. No radio/server/automatic start input,
