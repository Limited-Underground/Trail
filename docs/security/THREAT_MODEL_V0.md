...
| Malicious current member | Treat membership as access to current group traffic; rate-limit, support removal/key rotation, and never equate group membership with administrator authority |
