...
- Optional server-side breadcrumb recovery has only host-tested local capture
  and volatile no-overwrite outbox boundaries. No remote archive, account,
  retention, durable server result, or promised service exists.
