...
| --- | --- | --- |
| [Architecture decisions](decisions/) | Recorded constraints that future work must preserve | [Firmware bundle signatures](decisions/0006-firmware-bundle-signature.md) |
