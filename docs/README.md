...
5. Close the five current readiness requirements, accept a new immutable executable benchmark plan, and run the exact candidate comparison under separate authority. OT-094 and OT-097 retain the historical six-blocker state.
