...
4. Preserve the accepted [OT-093 pre-crypto build baseline](../tests/hardware/OT-093-2026-08-20.md), blocked [OT-094 candidate-readiness contract](../tests/hardware/OT-094-2026-08-20.md), historical non-admitting [OT-095 source-lock contract](../tests/hardware/OT-095-2026-08-20.md), bounded [OT-096 mbedTLS static assessment](../tests/hardware/OT-096-2026-08-20.md), license-aware [OT-097 source-lock admission v1](../tests/hardware/OT-097-2026-08-20.md), exact [OT-102 Monocypher source-lock admission](../tests/hardware/OT-102-2026-08-20.md), exact [OT-103 received-target profile admission](../tests/hardware/OT-103-2026-08-20.md), exact [OT-105 pinned mbedTLS/PSA source-lock admission](../tests/hardware/OT-105-2026-08-21.md), accepted [OT-116 successor review and phased plan](../tests/hardware/OT-116-2026-08-22.md), complete [OT-117 libsodium API/configuration admission](../tests/hardware/OT-117-2026-08-22.md), and partial [OT-118 Monocypher API/configuration admission](../tests/hardware/OT-118-2026-08-22.md).
5. Under the frozen OT-116 plan, OT-117 and OT-118 populate all three candidate API/configuration registries. Current source/API/import counts are `3/3/0`; independently admit every retained import/build anchor and the second measurement node's exact profile, then run the exact candidate comparison only under fresh separate authority. Monocypher and mbedTLS/PSA remain partial, comparison-only, and structurally nonselectable; measurement remains blocked.
