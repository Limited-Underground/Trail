...
| --- | --- |
| Understand V1 and V1.5 | [Permanent V1/V1.5 acceptance scope](testing/V1_V1_5_ACCEPTANCE_SCOPE_V0.md), [scope/security decision](decisions/0033-permanent-v1-v1-5-scope-and-security-boundary.md), [host-tested BLE pairing/replacement contract](platform/BLE_PAIRING_REPLACEMENT_V0.md), [host-tested secure-LoRa lifecycle/admission contract](security/SECURE_LORA_KEY_TRANSPORT_V0.md), [pre-crypto build baseline decision](decisions/0037-pre-crypto-build-baseline.md), [blocked candidate-readiness decision](decisions/0038-host-only-ot005-candidate-readiness-contract.md), [capacity policy](testing/FIRST_RELEASE_CAPACITY_V0.md), and [product boundaries](PRODUCT_BOUNDARIES_V0.md) |
...
| Review identity or security | [Secure-LoRa lifecycle/admission contract](security/SECURE_LORA_KEY_TRANSPORT_V0.md), [Decision 0035](decisions/0035-host-tested-secure-lora-key-transport-contract.md), [pre-crypto build baseline decision](decisions/0037-pre-crypto-build-baseline.md), [blocked candidate-readiness decision](decisions/0038-host-only-ot005-candidate-readiness-contract.md), [OT-094 host evidence](../tests/hardware/OT-094-2026-08-20.md), [benchmark evidence boundary](security/CRYPTO_BENCHMARK_EVIDENCE_V0.md), [threat model](security/THREAT_MODEL_V0.md), [group lifecycle](security/GROUP_LIFECYCLE_V0.md), and [crypto candidate review](security/CRYPTO_CANDIDATE_REVIEW_2026-08-10.md) |
...
4. Preserve the accepted [OT-093 pre-crypto build baseline](../tests/hardware/OT-093-2026-08-20.md) and blocked [OT-094 candidate-readiness contract](../tests/hardware/OT-094-2026-08-20.md).
