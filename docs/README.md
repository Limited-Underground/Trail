...
4. Preserve the accepted [OT-093 pre-crypto build baseline](../tests/hardware/OT-093-2026-08-20.md), blocked [OT-094 candidate-readiness contract](../tests/hardware/OT-094-2026-08-20.md), and zero-source [OT-095 source-lock admission contract](../tests/hardware/OT-095-2026-08-20.md).
