...
| Work on position sharing or optional breadcrumb archiving | [GPS abstraction](location/GPS_ABSTRACTION.md), [position scheduler](protocol/POSITION_BROADCAST_SCHEDULER_V0.md), [privacy control](platform/POSITION_SHARING_CONTROL_V0.md), [checked-time archive retry](location/BREADCRUMB_ARCHIVE_RETRY_V0.md), and [privacy-safe archive presentation](location/BREADCRUMB_ARCHIVE_PRESENTATION_V0.md) |
