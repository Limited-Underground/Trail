...
| Work on a portable client target | [Portable-client composition](platform/PORTABLE_CLIENT_COMPOSITION_V0.md), [build-only Heltec V4 bench candidate](../firmware/targets/heltec_v4_bench/README.md), [OT-103 exact received-target profile](../tests/hardware/OT-103-2026-08-20.md), [OT-093 reproducible pre-crypto baseline](../tests/hardware/OT-093-2026-08-20.md), [OT-059 exact-profile evidence](../tests/hardware/OT-059-2026-08-15.md), [OT-056 runtime-owner evidence](../tests/hardware/OT-056-2026-08-15.md), [development guide](DEVELOPMENT.md), and [hardware inventory](../hardware/INVENTORY.md) |
...
2. Use [Decision 0103](decisions/0103-adopt-ot168-v1-factory-reset-and-boot-pairing.md) and the [Device Factory Reset Contract v1](platform/DEVICE_FACTORY_RESET_V1.md) as the current pairing/recovery authority. Retain [OTBP0/v0](platform/BLE_PAIRING_REPLACEMENT_V0.md) only as historical host evidence.
...
4. Preserve the accepted [OT-093 pre-crypto build baseline](../tests/hardware/OT-093-2026-08-20.md), blocked [OT-094 candidate-readiness contract](../tests/hardware/OT-094-2026-08-20.md), historical non-admitting [OT-095 source-lock contract](../tests/hardware/OT-095-2026-08-20.md), bounded [OT-096 mbedTLS static assessment](../tests/hardware/OT-096-2026-08-20.md), license-aware [OT-097 source-lock admission v1](../tests/hardware/OT-097-2026-08-20.md), exact [OT-102 Monocypher source-lock admission](../tests/hardware/OT-102-2026-08-20.md), exact [OT-103 received-target profile admission](../tests/hardware/OT-103-2026-08-20.md), exact [OT-105 pinned mbedTLS/PSA source-lock admission](../tests/hardware/OT-105-2026-08-21.md), accepted [OT-116 successor review and phased plan](../tests/hardware/OT-116-2026-08-22.md), complete [OT-117 libsodium API/configuration admission](../tests/hardware/OT-117-2026-08-22.md), partial [OT-118 Monocypher API/configuration admission](../tests/hardware/OT-118-2026-08-22.md), second-node [OT-119 exact-profile admission](../tests/hardware/OT-119-2026-08-22.md), and atomic [OT-120 retained import/build admission](../tests/hardware/OT-120-2026-08-22.md).
5. Under the frozen OT-116 plan, Phase 0 and Phase 1 are complete at source/API/import counts `3/3/3`. Run the exact candidate comparison only under fresh separate authority. Monocypher and mbedTLS/PSA remain partial, comparison-only, and structurally nonselectable; libsodium remains structurally eligible but unselected; measurement remains blocked until that fresh authority exists.
6. Explicitly accept the suite/library, handshake/KDF, and packet-v1 wire selection only after that benchmark passes.
7. Then implement and physically accept the OT-168 unowned-boot pairing/factory-reset contract and selected secure-LoRa paths only under separate authority.
