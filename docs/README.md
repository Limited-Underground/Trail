...
| Work on local quick-status selection | [Revision-safe quick-status menu](platform/QUICK_STATUS_MENU_COORDINATOR_V0.md), [local interface](platform/LOCAL_INTERFACE_V0.md), and [payload contract](protocol/QUICK_STATUS_PAYLOAD_V0.md) |
