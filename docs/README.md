...
4. Preserve the accepted [OT-093 pre-crypto build baseline](../tests/hardware/OT-093-2026-08-20.md), blocked [OT-094 candidate-readiness contract](../tests/hardware/OT-094-2026-08-20.md), historical non-admitting [OT-095 source-lock contract](../tests/hardware/OT-095-2026-08-20.md), bounded [OT-096 mbedTLS static assessment](../tests/hardware/OT-096-2026-08-20.md), license-aware [OT-097 source-lock admission v1](../tests/hardware/OT-097-2026-08-20.md), exact [OT-102 Monocypher source-lock admission](../tests/hardware/OT-102-2026-08-20.md), exact [OT-103 received-target profile admission](../tests/hardware/OT-103-2026-08-20.md), and exact [OT-105 pinned mbedTLS/PSA source-lock admission](../tests/hardware/OT-105-2026-08-21.md).
5. Close the three current readiness requirements, accept a new immutable executable benchmark plan, and run the exact candidate comparison under separate authority. OT-094 and OT-097 retain the historical six-blocker state; OT-100 the prior five-blocker state; OT-102 the prior four-blocker state; OT-103 the prior three-blocker state; and OT-105 the current three-blocker state.
