...
OT-149 prepares and host-validates the missing five-operation mbedTLS/PSA comparison target, matched no-candidate control, strict 1,015-frame parser/schema, and the signed/zero-capable matched linked-flash/static-RAM accounting successor. Fresh full ESP32-S3 builds pass for both sides with zero compiler warnings and byte-identical 106,890-byte generated sdkconfigs. This is preparation only: no benchmark or matched-size result was executed, no hardware or radio was accessed, and no authority, selection, Phase 2 completion, field-readiness, or score claim is added. The public website remains on the normal batched update cadence. V1 remains exact 43.75%/displayed 44%. See [Decision 0085](decisions/0085-prepare-mbedtls-psa-target-and-resource-successor.md), [OT-149 evidence](../tests/hardware/OT-149-2026-08-26.md), [target preparation](../tests/benchmarks/crypto/OT-149-OT005-MBEDTLS-PSA-TARGET-PREPARATION-V0.json), and [resource successor](../tests/benchmarks/crypto/OT-149-OT005-MATCHED-RESOURCE-ACCOUNTING-SUCCESSOR-V1.json).
