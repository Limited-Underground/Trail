...
OT-145 accepts one fresh explicitly approved `OT144MOAA0` authority for the unchanged host-validated OT-144 preparation. The 3,775-byte authority has raw SHA-256 `29c84ae8de494be2ac08e35cdeba5c4409f9381bc4f457a29cef64fb391afe31`, binds the corrected 149,824-byte application, exact Trail restoration image, OT-144 coordinator/adapter, and every accepted fail-closed transport, privacy, preflight, and restoration boundary. It remains unexecuted and permits only one two-node application-only attempt from this workspace; success or abort consumes it, it is non-reusable, grants no continuation, and permits no radio use. No device, endpoint, reset, flash, benchmark, radio, or phone operation occurred, and no private journal or terminal receipt exists. The latest admitted benchmark remains OT-122; V1 remains exact 43.75%/displayed 44%, and the historical baseline remains exact 31.75%/displayed 32%. See [Decision 0082](decisions/0082-accept-ot145-one-attempt-authority.md), [OT-145 evidence](../tests/hardware/OT-145-2026-08-26.md), and the [authority](../tests/benchmarks/crypto/OT-144-OT005-MONOCYPHER-ONE-ATTEMPT-AUTHORITY-V0.json).
