...
- Connected GPS/GNSS hardware still needs exact module/wiring identification, target-profile binding, fix/loss evidence, and suitable antenna/power validation.
