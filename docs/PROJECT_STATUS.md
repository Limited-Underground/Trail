...
OT-157 now accepts the host-only reset-aware Noise XK executable/restoration successor. The exact OT-156 runner/runtime is bound to fresh coordinator, adapter, journal, execution-receipt, and recovery-receipt namespaces; the unchanged OT-153 firmware and exact Trail restoration application remain hash-locked. Independent restoration remains unconditional, and only sixteen privacy-safe failure stages may enter sanitized receipts. Focused OT-157 suites pass 22/22, OT-156 suites pass 17/17, the frozen OT-153 chain passes 75/75, the authoritative raw-byte audit passes, and the complete Windows Host matrix passes locally with exit 0. This freezes the corrected host lifecycle but does not prove the physical OT-155 root cause. OT-157 grants no authority; OT-158 is the separate fresh explicit non-reusable one-attempt authority gate. No device, firmware, radio, result, selection, Phase 2 completion, readiness, support, release, regulatory, or score claim changes. V1 remains exact 43.75%/displayed 44%, and no website update is required. See [Decision 0093](decisions/0093-freeze-ot157-reset-aware-noise-xk-radio-executable-bundle.md), [OT-157 evidence](../tests/hardware/OT-157-2026-08-28.md), and the [canonical preparation](../tests/benchmarks/crypto/OT-157-OT005-LIBSODIUM-NOISE-XK-RADIO-EXECUTABLE-BUNDLE-PREPARATION-V0.json).
