...
OT-163 remains accepted immutable restored-abort history. Its consumed authority grants no retry or continuation. See [Decision 0099](decisions/0099-record-ot163-noise-xk-radio-execution-abort.md) and [OT-163 evidence](../tests/hardware/OT-163-2026-08-28.md).
...
OT-160 accepts the minimal host-only correction for the deterministic OT-157 composition defect. Source locks now use `_source_sha256(Path)`, while application readback reaches the unchanged inherited `_sha256(bytes)` helper. The real composed preflight path passes exact mocked readbacks and fails closed for corrupt and short readbacks after reading and resetting both anonymous roles. No write, radio open, journal, receipt, physical device operation, bundle, or authority occurred. Focused validation passes 13/13 and the raw-byte audit passes 264/264. OT-161 must freeze the exact corrected executable/restoration bundle; OT-162 must later accept fresh explicit non-reusable authority before any corrected hardware execution. No result, selection, Phase 2 completion, readiness, support, release, regulatory, score, or website status changes. V1 remains exact 43.75%/displayed 44%. See [Decision 0096](decisions/0096-accept-ot160-noise-xk-hash-helper-host-correction.md) and [OT-160 evidence](../tests/hardware/OT-160-2026-08-28.md).

OT-159 records a deterministic pre-consumption host-composition blockage. Both anonymous nodes passed direct exact-Trail application readback and reset, but both official OT-157-bound preflight attempts failed before journal creation because its file-hash helper shadows the inherited byte-hash helper used by the adapter. No benchmark write, radio operation, execution or recovery receipt, result, or authority consumption occurred. Focused OT-157-through-OT-159 regression validation passes 40/40, the raw-byte audit passes 258/258, and the complete Windows Host matrix exits 0. The OT-158 authority remains unused and unconsumed, but its immutable binding cannot authorize corrected code. OT-160 must create the minimal host-only successor before a corrected bundle and fresh authority. No selection, Phase 2 completion, readiness, support, release, regulatory, score, or website status changes. V1 remains exact 43.75%/displayed 44%. See [Decision 0095](decisions/0095-record-ot159-preconsumption-noise-xk-blockage.md), [OT-159 evidence](../tests/hardware/OT-159-2026-08-28.md), and the [sanitized blockage record](../tests/benchmarks/crypto/OT-159-OT005-LIBSODIUM-NOISE-XK-RADIO-PRECONSUMPTION-BLOCKAGE-V0.json).

OT-158 now accepts the owner-approved `OT158NXRA0` authority for the exact OT-157 reset-aware executable/restoration bundle. The 4,545-byte canonical authority has raw SHA-256 `b696598cfdd71d04c2685dc50d74da5cd435ff064a6c1c5ffa985e490f4070f1` and canonical payload SHA-256 `1cc9b0965cec4ffc5eab87d0045aa5ee5e73e65d75e204ca338cfb2b8ffeac0d`. It binds the benchmark and 500,944-byte Trail applications, OT-156 reset-aware runner/runtime, OT-157 restoration-safe coordinator and concrete adapter, anonymous roles, fresh private one-use state, and success-or-abort consumption. Focused authority tests pass 10/10, the complete OT-153-through-OT-158 Noise XK chain passes 139/139, the raw-byte audit passes 254/254, and the complete Windows Host matrix passes locally with exit 0. The authority permits exactly one later two-node application-only attempt from this workspace, is non-reusable, grants no continuation, and remains unexecuted. OT-159 is the sole permitted execution step. No device, endpoint, serial, reset, flash, radio, phone, private journal, terminal receipt, result, selection, Phase 2 completion, readiness, support, release, regulatory, or score claim changes. V1 remains exact 43.75%/displayed 44%, and no website update is required. See [Decision 0094](decisions/0094-accept-ot158-noise-xk-radio-one-attempt-authority.md), [OT-158 evidence](../tests/hardware/OT-158-2026-08-28.md), and the [canonical authority](../tests/benchmarks/crypto/OT-158-OT005-LIBSODIUM-NOISE-XK-RADIO-ONE-ATTEMPT-AUTHORITY-V0.json).

OT-157 remains immutable host-only executable/restoration bundle history and grants no inherited authority. See [Decision 0093](decisions/0093-freeze-ot157-reset-aware-noise-xk-radio-executable-bundle.md), [OT-157 evidence](../tests/hardware/OT-157-2026-08-28.md), and the [canonical preparation](../tests/benchmarks/crypto/OT-157-OT005-LIBSODIUM-NOISE-XK-RADIO-EXECUTABLE-BUNDLE-PREPARATION-V0.json).

OT-155 consumes the sole OT-154 authority on one fail-closed `radio_run_failed` attempt. Both anonymous nodes pass installed-Trail preflight/reset and benchmark readback/reset before the radio path is invoked, but no radio result passes validation. Both nodes then pass exact Trail restoration readback/reset; restoration is complete and no recovery is required. The frozen boundary does not preserve an exact safe substage, so no host, USB, firmware, or physical-radio root cause is claimed. The authority is consumed, non-reusable, and grants no continuation. OT-156 later satisfies the separate host-only reset/reconnect and safe-stage correction gate. No result, selection, Phase 2 completion, readiness, support, release, regulatory, or score claim changes. See [Decision 0091](decisions/0091-record-ot155-noise-xk-radio-execution-abort.md), [OT-155 evidence](../tests/hardware/OT-155-2026-08-27.md), and the [sanitized receipt](../tests/benchmarks/crypto/OT-155-OT005-LIBSODIUM-NOISE-XK-RADIO-EXECUTION-ABORT-RECEIPT-V0.json).

OT-154 remains immutable consumed authority history and grants no inherited or replacement device access. See [Decision 0090](decisions/0090-accept-ot154-noise-xk-radio-one-attempt-authority.md), [OT-154 evidence](../tests/hardware/OT-154-2026-08-27.md), and the [canonical authority](../tests/benchmarks/crypto/OT-154-OT005-LIBSODIUM-NOISE-XK-RADIO-ONE-ATTEMPT-AUTHORITY-V0.json).

OT-153 remains immutable host-only executable/restoration bundle history and grants no inherited authority. See [Decision 0089](decisions/0089-freeze-noise-xk-radio-executable-bundle.md), [OT-153 evidence](../tests/hardware/OT-153-2026-08-27.md), and the [canonical preparation](../tests/benchmarks/crypto/OT-153-OT005-LIBSODIUM-NOISE-XK-RADIO-EXECUTABLE-BUNDLE-PREPARATION-V0.json).

OT-152 remains the immutable host-only measurement-contract history. It authorizes no inherited hardware or radio operation. See [Decision 0088](decisions/0088-prepare-noise-xk-radio-cost-measurement.md), [OT-152 evidence](../tests/hardware/OT-152-2026-08-27.md), and the [canonical preparation](../tests/benchmarks/crypto/OT-152-OT005-LIBSODIUM-NOISE-XK-RADIO-COST-PREPARATION-V0.json).

OT-151 records the sole OT-150-authorized attempt as a consumed, exactly restored abort. Node A passed benchmark readback before `capture_failed` / `frame_count_incomplete`; Node A restored/readback/reset exactly to Trail, Node B was never benchmark-written and remained on Trail, and the owner confirmed both logos. Exact accounting proves the 1,468 observed bytes were a complete early terminal vector-failure transcript, not a partial write. Frozen-ELF inspection then proves the benchmark fixture correctly received `PSA_ERROR_INVALID_ARGUMENT` for an all-zero X25519 peer but incorrectly rejected pinned TF-PSA's deliberate full-length randomized failure buffer. A separate host-only successor removes only the invalid error `output_length == 0` assertion, retains status rejection and zeroization, and immediately classifies only canonical early terminal failures while preserving the exact 1,015-frame success contract. The authority is consumed and no new hardware attempt is authorized. No result, radio, selection, Phase 2 completion, readiness, or score claim is added; V1 remains exact 43.75%/displayed 44%. No website update is required. See [Decision 0087](decisions/0087-record-ot150-abort-and-correct-mbedtls-psa-successor.md), [OT-151 evidence](../tests/hardware/OT-151-2026-08-27.md), and the [sanitized receipt](../tests/benchmarks/crypto/OT-151-OT005-MBEDTLS-PSA-EXECUTION-ABORT-RECEIPT-V0.json).

OT-150 remains accepted immutable host-only bundle/resource history. Its later one-attempt authority is now consumed and non-reusable; it grants no inherited or replacement device access. See [Decision 0086](decisions/0086-freeze-ot150-mbedtls-psa-executable-resource-bundle.md), [OT-150 evidence](../tests/hardware/OT-150-2026-08-27.md), [canonical preparation](../tests/benchmarks/crypto/OT-150-OT005-MBEDTLS-PSA-EXECUTABLE-RESOURCE-BUNDLE-PREPARATION-V0.json), and [authority](../tests/benchmarks/crypto/OT-150-OT005-MBEDTLS-PSA-ONE-ATTEMPT-AUTHORITY-V0.json).

OT-149 remains accepted compile-validation history. Its unpinned application BIN/ELF identities are not execution-eligible and are neither relabeled nor replaced by OT-150.

OT-148 independently reconciles the accepted OT-005 evidence against the frozen OT-116 plan. Libsodium 1.0.22 is the only candidate with admitted 8/8 coverage and structural selection eligibility, so it is the evidence-backed recommendation, not a selection. mbedTLS/PSA measurement, matched linked-flash/static-RAM results under a signed/zero-capable admission, Noise XK radio cost, all eight named gates, private trace-custody verification, and separate Phase 3 admission remain open. No library, suite, handshake/KDF, or Packet-v1 wire format is selected. OT-148 is host-only and adds no hardware authority, device access, score, field-readiness claim, or immediate website update. V1 remains exact 43.75%/displayed 44%. See [Decision 0084](decisions/0084-reconcile-incomplete-phase-two-before-selection.md), [OT-148 evidence](../tests/hardware/OT-148-2026-08-26.md), and the [reconciliation record](../tests/benchmarks/crypto/OT-148-OT005-PHASE-TWO-CORPUS-RECONCILIATION-V0.json).

OT-147 consumed its explicitly approved one-attempt authority on one successful two-device application-only update. Both anonymous Heltec units were flashed, independently read back, and hard-reset to the exact 500,944-byte application with SHA-256 `f2a58414f82eed585ba90bf7671b06c8ebfaa82e8b23f6ac2093de95143b4e0e`; the owner visually confirmed that both displays show live `BAT` and `GPS` values. The battery percentage is an approximate voltage-derived estimate, not a calibrated fuel-gauge result, and the satellite count does not prove GNSS fix, position accuracy, or fix-loss behavior. LoRa activity-arrow binding remains absent. This adds no power-endurance, support, compatibility, regulatory, production, secure-LoRa, end-to-end, or field-readiness proof. V1 remains exact 43.75%/displayed 44%, and the historical baseline remains exact 31.75%/displayed 32%. See [OT-147 evidence](../tests/hardware/OT-147-2026-08-26.md).

OT-146 consumes that single authority on one successful two-node application-only comparison. Both anonymous nodes passed benchmark readback, all five admitted Monocypher operations with 100 data-cache-conditioned and 100 warm samples per operation, strict validation of all 1,014 result frames, exact Trail restore readback, and hard reset; the owner confirmed both displays were back on. Radio remained unused and recovery was not required. The bounded result is admitted, but Phase 2 remains unaccepted until a separate host-only admission and no candidate, suite/library, handshake/KDF, or packet-v1 wire format is selected. Support, compatibility, regulatory, production, secure-LoRa, end-to-end, field-readiness, and score claims remain unchanged. V1 remains exact 43.75%/displayed 44%, and the historical baseline remains exact 31.75%/displayed 32%. See [Decision 0083](decisions/0083-record-ot146-ot145-monocypher-execution-success.md), [OT-146 evidence](../tests/hardware/OT-146-2026-08-26.md), and the [sanitized receipt](../tests/benchmarks/crypto/OT-146-OT005-MONOCYPHER-EXECUTION-RECEIPT-V0.json).

OT-145 accepted the fresh explicitly approved `OT144MOAA0` authority for the unchanged host-validated OT-144 preparation. The 3,775-byte authority has raw SHA-256 `29c84ae8de494be2ac08e35cdeba5c4409f9381bc4f457a29cef64fb391afe31` and bound the corrected 149,824-byte application, exact Trail restoration image, OT-144 coordinator/adapter, and every accepted fail-closed transport, privacy, preflight, and restoration boundary. OT-146 has now consumed its sole two-node application-only attempt successfully. It remains non-reusable, grants no continuation, and permits no radio use. See [Decision 0082](decisions/0082-accept-ot145-one-attempt-authority.md), [OT-145 evidence](../tests/hardware/OT-145-2026-08-26.md), and the [authority](../tests/benchmarks/crypto/OT-144-OT005-MONOCYPHER-ONE-ATTEMPT-AUTHORITY-V0.json).

OT-144 records a host-only fail-closed discovery before device I/O: the accepted OT-143 authority is unconsumed but non-executable because its preparation/authority pin the corrected 149,824-byte OT-142 application while the coordinator invoked by its adapter still pins the historical 149,920-byte OT-139 image. No OT-143 journal or receipt exists, and no device, endpoint, flash, reset, benchmark, radio, or phone operation occurred. Decision 0080 and all OT-143 artifacts remain immutable history. A fresh OT-144 runtime/preparation now binds the corrected application consistently across coordinator, adapter, preparation, and real-file validation, while preserving all preflight, transport/parser, privacy, and exact-restoration boundaries. OT-144 creates no authority; fresh separate explicit non-reusable one-attempt authority remains mandatory before hardware. No benchmark result, radio, selection, Phase 2 completion, support, regulatory, production, end-to-end, or score claim is added. The latest admitted benchmark remains OT-122; V1 remains exact 43.75%/displayed 44%, and the historical baseline remains exact 31.75%/displayed 32%. See [Decision 0081](decisions/0081-correct-ot143-runtime-binding-before-hardware.md), [OT-144 evidence](../tests/hardware/OT-144-2026-08-26.md), and the [corrected preparation](../tests/benchmarks/crypto/OT-144-OT005-MONOCYPHER-EXECUTABLE-BUNDLE-PREPARATION-V0.json).

OT-143 remains immutable historical evidence. Decision 0080 accepted raw authority SHA-256 `235e1227ef8ebed75a510335b017f9c0539d0508426a11414546591002f1bce0`; OT-144 later proves it was never consumed but cannot execute its own corrected image because the accepted coordinator pins the older image. It grants no inherited or replacement hardware attempt. See [Decision 0080](decisions/0080-freeze-ot143-corrected-target-bundle-and-authority.md), [OT-143 evidence](../tests/hardware/OT-143-2026-08-26.md), [build evidence](../tests/benchmarks/crypto/OT-143-OT005-MONOCYPHER-CORRECTED-TARGET-BUILD-EVIDENCE-V0.json), [preparation](../tests/benchmarks/crypto/OT-143-OT005-MONOCYPHER-EXECUTABLE-BUNDLE-PREPARATION-V0.json), and [authority](../tests/benchmarks/crypto/OT-143-OT005-MONOCYPHER-ONE-ATTEMPT-AUTHORITY-V0.json).

OT-142 records that the OT-140 authority was consumed by one fail-closed attempt with exact restoration and no admitted result. Host-only investigation traced the deterministic primitive-gate failure to a malformed RFC 8032 seed in the benchmark-only fixture, not to either device or the pinned Monocypher implementation. A separate successor changes only that seed, verifies the RFC vector through the real library, reproduces two matching fresh build tuples, and passes the complete Windows host matrix. OT-143 later supplies the required immutable binding and fresh explicit one-attempt authority; completion and score remain unchanged. The latest admitted benchmark remains OT-122 and V1 remains exact 43.75%/displayed 44%.
...
OT-139 accepts the separate host-only Monocypher quiet target required by OT-138. It compiles the frozen OT-129 application/control sources by reference while resolving primary and secondary ESP-IDF consoles, bootloader logging, and default/maximum application logging to none; the direct USB Serial/JTAG driver and normal ROM logging remain enabled. Two fresh, initially absent, cache-disabled ESP-IDF 6.0.2 builds produced identical application BIN/ELF/map, bootloader BIN, partition-table BIN, and generated sdkconfig artifacts. This does not prove physical endpoint silence from reset. Frozen transport/parser boundaries are unchanged, and OT-139 creates no immutable executable binding or authority. The next gate is a separate exact bundle binding and fresh explicit non-reusable one-attempt authority before device access. No benchmark result, timing, resource result, radio, selection, Phase 2 completion, support, regulatory, production, end-to-end, or score claim is added. The latest admitted benchmark remains OT-122; V1 remains exact 43.75%/displayed 44%. See [Decision 0078](decisions/0078-accept-reproducible-monocypher-quiet-target.md), [OT-139 evidence](../tests/hardware/OT-139-2026-08-25.md), and the [canonical two-build evidence](../tests/benchmarks/crypto/OT-139-OT005-MONOCYPHER-QUIET-TARGET-BUILD-EVIDENCE-V0.json).

OT-138 accepts the host-only classification of the OT-137 partial-data/live boot-control boundary. Fabricated bytes reproduce the exact public OT-137 counter shape and prove that the frozen runner can charge already queued startup traffic and post-START preamble to the same 512-byte budget, aborting before the 250 ms START retry. The exact accepted build structurally shares USB Serial/JTAG between its INFO-level startup console and later direct control protocol; runtime log suppression begins only in app_main. The actual OT-137 byte contents remain unconfirmed. The next gate is a host-only console-isolated quiet-target configuration and two fresh matching BIN/ELF/map/sdkconfig builds, without changing frozen runners or weakening any 512-byte/time, exact READY/frame, privacy, or real-parser boundary. OT-138 creates no firmware successor, executable bundle, authority, or hardware attempt. No benchmark result, timing, resource result, radio, selection, Phase 2 completion, support, regulatory, production, end-to-end, or score claim is added. The latest admitted benchmark remains OT-122; V1 remains exact 43.75%/displayed 44%. See [Decision 0077](decisions/0077-classify-monocypher-boot-control-transport-conflict.md) and [OT-138 evidence](../tests/hardware/OT-138-2026-08-25.md).

OT-137 records the single OT-136-authorized application-only attempt. The non-consuming preflight verified/reset both exact Trail applications and the owner confirmed both logos. Node A then passed benchmark readback before capture failed closed as `capture_failed` / `preamble_invalid`: two 512-byte reads observed 1,024 bytes; 11 complete opaque pre-READY records remained within the accepted complete-record allowance, then remaining partial pre-READY data crossed the cumulative 512-byte bound before any frame. Node A restored/readback/reset exactly to Trail, Node B was never benchmark-written after preflight and remained on Trail, and both logos were confirmed after the abort. The OT-136 authority is consumed and non-reusable. OT-137 passes 7/7, the frozen OT-136 suites pass 35/35, OT-135 and frozen OT-132 pass 14/14 each, and the raw-byte audit passes 82/82. No benchmark result, timing, resource result, radio, selection, Phase 2 completion, support, regulatory, production, end-to-end, or score claim is added. The latest admitted benchmark remains OT-122; V1 remains exact 43.75%/displayed 44%. No further Monocypher hardware attempt is authorized; next investigate the bounded partial-data/live boot-control boundary host-only before any new immutable successor and fresh authority. See [Decision 0076](decisions/0076-record-ot137-ot136-execution-abort.md), [OT-137 evidence](../tests/hardware/OT-137-2026-08-25.md), and the [sanitized abort receipt](../tests/benchmarks/crypto/OT-137-OT005-MONOCYPHER-EXECUTION-ABORT-RECEIPT-V0.json).

OT-134 permanently corrects deterministic Windows Host validation checkout drift without changing accepted bytes or hashes. The last green was OT-092 run 210; OT-093 run 211 was the first red with the older OTCBL0 signature; exact OTCAI failure began at OT-098 run 217. OT-098 exists, is 5,454 bytes versus its 131,072-byte limit, and matches its expected SHA-256; unpinned CRLF conversion alone caused the mismatch. Run 262 proved OTCAI 4/4 and OT-099 5/5 green before exposing the same issue at OT-100. Deterministic LF, CRLF, and exact mixed-byte policy now covers every known raw-bound input; the new audit checks 69 files and focused OT-100 passes 6/6. Run 263 then exposed the separate depth-one checkout omission at the later OT-093 historical gate; complete-history checkout and an early regression now preserve the required OT-092/OT-093 objects, and the complete Windows host matrix passes locally. No firmware, hardware, phone, product capability, V1 percentage, or website status changes. See [Decision 0073](decisions/0073-freeze-windows-raw-evidence-checkout-bytes.md) and [OT-134 evidence](../tests/hardware/OT-134-2026-08-24.md).

OT-135 accepts a host-only byte-bounded preamble successor without altering OT-129 through OT-133. Complete opaque pre-READY records are admitted only while their cumulative complete-record bytes stay within the unchanged 512-byte budget and fixed control deadline; the redundant eight-record ceiling is removed because the byte budget already bounds record count. Nine fabricated records totaling 512 bytes and 64 short records within budget pass; byte 513 and pre-READY frame, exact/duplicate READY, post-READY, deadline, privacy, and real 1,014-frame parser boundaries remain strict. OT-135 and frozen OT-132 tests each pass 14/14, and the raw-byte audit covers 71 deterministic inputs. No hardware, flash, benchmark, radio, result, selection, Phase 2 completion, score, or website status changes. OT-136 later supplied the required immutable executable binding and fresh authority at that historical checkpoint. OT-137 consumed it on an exactly restored fail-closed abort; no Monocypher hardware attempt is currently authorized. See [Decision 0074](decisions/0074-host-only-monocypher-byte-bounded-preamble-correction.md) and [OT-135 evidence](../tests/hardware/OT-135-2026-08-25.md).

OT-133 accepts the fresh immutable OT-132 successor bundle and records its single consumed attempt. Node A passed benchmark readback before capture failed closed as `capture_failed` / `preamble_invalid`; one 512-byte read contained nine complete pre-READY records, exceeding the frozen eight-record cap before any result frame was accepted. Node A restored/readback/reset exactly to Trail, Node B was never benchmark-written and remained on Trail, and the owner confirmed both Trail logos. The authority is consumed and nonreusable. No result, radio, selection, Phase 2 completion, support, regulatory, production, end-to-end, or score claim is added. OT-135 later accepts the host-only byte-bounded correction; any later device access still requires a new immutable successor and fresh explicit one-attempt authority. V1 remains exact 43.75%/displayed 44%. See [Decision 0072](decisions/0072-record-ot133-immutable-successor-execution-abort.md), [OT-133 evidence](../tests/hardware/OT-133-2026-08-24.md), and the [sanitized abort receipt](../tests/benchmarks/crypto/OT-133-OT005-MONOCYPHER-EXECUTION-ABORT-RECEIPT-V0.json).

OT-132 accepts a new host-only successor runner that treats complete pre-READY records as opaque only within the unchanged eight-record/512-byte limits. Exact READY, frame-before-READY rejection, post-READY frame strictness, fixed deadlines, privacy-safe counters, and the unchanged 1,014-frame parser remain enforced; 14/14 adversarial tests and the frozen OT-129 through OT-131 regression gates pass. No hardware, flash, benchmark, radio, authority, result, selection, Phase 2 completion, support, regulatory, production, end-to-end, or score claim is added. OT-131 remains consumed; the next gate is a new immutable executable binding and fresh explicit one-attempt authority. V1 remains exact 43.75%/displayed 44%. See [Decision 0071](decisions/0071-host-only-monocypher-opaque-preamble-correction.md) and [OT-132 evidence](../tests/hardware/OT-132-2026-08-24.md).

OT-131 records the single executable Monocypher attempt as aborted and fully restored. Node A passed benchmark readback, then capture failed closed as `capture_failed` / `preamble_invalid`; bounded public diagnostics retain only lifecycle `stable_continuous`, one reset/open/START write, 512 observed bytes, one complete line, and zero frame lines. Node A restored/readback/reset exactly to Trail, Node B was never benchmark-flashed and remained on Trail, and the owner confirmed both Trail logos after the abort. The authority is consumed and nonreusable; no result, radio, selection, Phase 2 completion, support, regulatory, production, end-to-end, or score claim is added. V1 remains exact 43.75%/displayed 44%. See [Decision 0070](decisions/0070-record-ot131-monocypher-execution-abort.md), [OT-131 evidence](../tests/hardware/OT-131-2026-08-24.md), and the [sanitized abort receipt](../tests/benchmarks/crypto/OT-131-OT005-MONOCYPHER-EXECUTION-ABORT-RECEIPT-V0.json).

OT-130 accepts the host-only immutable Monocypher execution bundle and a fresh non-reusable one-attempt authority. The bundle binds the exact OT-129 source inputs, six-file ESP-IDF output tuple, START/READY transport, strict 1,014-frame parser/schema, restoration-safe two-node coordinator, and exact Trail restoration image. Two fresh, initially absent, cache-disabled ESP-IDF 6.0.2 builds reproduced the same application BIN, ELF, map, sdkconfig, bootloader, and partition-table tuple with zero compiler warnings; coordinator and preparation/authority tests each pass 11/11. At that checkpoint, no device, flash, benchmark, radio, or phone operation occurred; the authority was unexecuted, and the next permitted hardware step is only its one two-node application-only attempt, with both nodes restored exactly to Trail on success or abort. No selection, Phase 2 completion, support, compatibility, regulatory, production, or score claim is added; V1 remains exact 43.75%/displayed 44%. See [Decision 0069](decisions/0069-freeze-monocypher-execution-bundle-and-one-attempt-authority.md), [OT-130 evidence](../tests/hardware/OT-130-2026-08-24.md), the [immutable preparation](../tests/benchmarks/crypto/OT-130-OT005-MONOCYPHER-IMMUTABLE-EXECUTION-BUNDLE-PREPARATION-V0.json), and the [one-attempt authority](../tests/benchmarks/crypto/OT-130-OT005-MONOCYPHER-ONE-ATTEMPT-AUTHORITY-V0.json).

OT-129 accepts the computer-only Monocypher START/READY protocol correction required by OT-128. An isolated successor firmware target waits for exact START, accepts retransmissions idempotently, drains READY before the unchanged 1,014-frame stream, and preserves every frozen OT-123/125/127 input. The dependency-injected host transport retries START until READY, retains partial bytes across empty reads, proves observed re-enumeration or stable continuous presence, bounds printable startup chatter, starts the benchmark deadline at READY, and exposes only closed privacy-safe failures/counters without raw exception context. Focused validation and a pinned ESP-IDF 6.0.2 compile-only build pass. No hardware, flash, benchmark, radio, authority, selection, Phase 2 completion, or score claim was added. At that checkpoint, a fresh immutable firmware/runner/restoration binding and non-reusable authority remained required. See [Decision 0068](decisions/0068-host-only-monocypher-start-ready-protocol-correction.md) and [OT-129 evidence](../tests/hardware/OT-129-2026-08-24.md).

OT-128 records the OT-127 one-time Monocypher attempt as aborted after Node A benchmark readback without a validated capture. Both nodes passed exact installed-Trail readback; only Node A was benchmark-written, and Node A was restored, readback-verified, and reset to exact Trail. A later non-writing hard reset succeeded on both devices and both USB endpoints returned. After the immutable receipt was prepared, the owner visually confirmed both Trail displays on. The private receipt does not classify the capture failure, so the physical root cause remains unconfirmed. Source inspection now requires a start-ready handshake, byte accumulation across partial reads, verified endpoint lifecycle, and privacy-safe failure categories before any fresh authority. Decision 0066 was consumed and, at that checkpoint, no further Monocypher hardware attempt was authorized. No frame, timing, primitive, resource, or benchmark result is admitted. V1 remains exact 43.75%/displayed 44%. See [Decision 0067](decisions/0067-record-monocypher-second-corrective-retry-abort.md), [OT-128 evidence](../tests/hardware/OT-128-2026-08-24.md), and the [sanitized abort receipt](../tests/benchmarks/crypto/OT-128-OT005-MONOCYPHER-SECOND-CORRECTIVE-RETRY-EXECUTION-ABORT-RECEIPT-V0.json).

OT-123 accepts the computer-only Monocypher five-of-eight comparison preparation without executing it. The strict 1,014-frame target/parser and digest-pinned fail-closed runner are ready; official RFC known-answer vectors and low-order X25519 rejection are pinned, both installed Trail applications must pass exact readback before any journal or write, and two fresh zero-warning ESP-IDF 6.0.2 builds reproduced the same 186,640-byte application image. A new matched-resource contract explicitly rejects BIN/ELF/map lengths, archives, symbol anchors, Trail, or OT-093 as false controls. The retained candidate JSON2 values are absolute only and include .noinit/TLS accounting; the no-candidate control is not built, so linked-flash and static-RAM deltas remain null. The current positive-only validator cannot admit signed zero/negative deltas, so a successor validator is required. No device, flash, benchmark, radio, selection, Phase 2 completion, or score claim is added. See [Decision 0062](decisions/0062-monocypher-comparison-benchmark-preparation.md) and [OT-123 evidence](../tests/hardware/OT-123-2026-08-23.md).
...
builds per candidate reproduce the accepted sdkconfigs, artifact tuples, and
retained operation anchors. Source/API-configuration/import counts are
`3/3/3`; phase 0 and phase 1 are complete. Measurement remains false and
blocked only by absent fresh benchmark execution authority. No benchmark,
device, flash, radio, key/entropy, candidate or suite/wire selection, support,
compatibility, regulatory, secure-LoRa, Packet V1, or score claim is added. See
[Decision 0058](decisions/0058-retained-candidate-import-build-admission.md)
and [OT-120 evidence](../tests/hardware/OT-120-2026-08-22.md).

OT-119 independently admits the exact received profile for the second measurement node, `OT-DEV-002`, through privacy-safe `OTRTPR0/v0`, `OTRTPE1/v1`, and append-only `OTRTPA1/v1`. A bounded no-stub ROM observation and owner-confirmed same-unit `HTIT-WB32LAF` / `V4.2` markings complete phase 0 while retaining no port, MAC/chip identifier, USB serial/hardware path, raw probe output, raw photo, local path, EXIF/location, or private device identity. Counts remain `3/3/0`; measurement remains false and blocked only by absent retained candidate import/build admissions and absent fresh benchmark execution authority. No support, compatibility, regulatory, benchmark, selection, secure-LoRa, Packet V1, or score claim changes. See [Decision 0057](decisions/0057-second-measurement-node-exact-profile-admission.md) and [OT-119 evidence](../tests/hardware/OT-119-2026-08-22.md).

OT-118 accepts strict five-of-eight host-only Monocypher API/configuration evidence for comparison measurement only under the frozen OT-116 procedure. Exact OT-107 source requirements and the 106,913-byte candidate-specific sdkconfig are bound and reproduced twice. SHA-256, HKDF-SHA256, and Noise XK remain unavailable, so Monocypher remains structurally nonselectable. All three API/configuration registries are populated and current source/API-configuration/import counts are `3/3/0`. At OT-118 acceptance, phase 0 remained incomplete because the second node lacked exact-profile admission, and every retained import/build anchor plus fresh execution authority was absent. OT-119 later closes the phase-zero item, and OT-120 later accepts all retained import/build anchors. Fresh execution authority remains absent. No benchmark, device, radio, production key/entropy, suite/wire selection, secure-LoRa implementation, physical evidence, or score claim changes. See [Decision 0056](decisions/0056-host-only-monocypher-api-configuration-admission.md) and [OT-118 evidence](../tests/hardware/OT-118-2026-08-22.md).

OT-117 accepts complete eight-of-eight host-only libsodium API/configuration evidence under the frozen OT-116 procedure. The exact candidate-specific OT-107 sdkconfig reproduced twice, and the hash-bound benchmark-only `OTNXK0/v0` composition completes the fixed operation set. At OT-117 acceptance, source/API-configuration/import counts were `3/2/0`; libsodium was structurally selection eligible but neither selected nor authorized for execution. Phase 0 remained incomplete pending Monocypher API/configuration and the second node's exact profile; every retained import/build anchor and fresh benchmark execution authority was also absent. OT-118 and OT-119 later close the phase-zero items, and OT-120 later accepts all retained import/build anchors. Fresh benchmark execution authority remains absent. No benchmark, device, radio, production key/entropy, suite/wire selection, secure-LoRa implementation, physical evidence, or score claim changes. See [Decision 0055](decisions/0055-host-only-libsodium-api-configuration-admission.md) and [OT-117 evidence](../tests/hardware/OT-117-2026-08-22.md).
...
v6.0.2 build produced a 473,152-byte application with SHA-256
`0C40AEB6C95ADE9940AA21065CBC73A72DCD82E96ADE9D13126693147FEB5741`.
Both automatic full-image writes verified and hard-reset successfully, and both
units emitted bounded `ot_bench` heartbeats. Owner-provided views show both
OLEDs lit; a clear close view reads `BAT:--% GPS:-- BLE:A` with the reserved
traffic field blank. The views were inspected transiently and are not retained
in the repository.

The display owner now redraws when footer pixels change under an unchanged BLE
phase and suppresses only an identical complete view. BLE advertising is the
only live footer field accepted by this run. Battery percentage and GNSS
satellites remain fail-closed placeholders, and the arrow remains blank because
no LoRa activity owner or radio is bound. OT-115 does not establish `BLE:C`,
live telemetry, radio traffic, GNSS, battery sensing, interactive UI/input,
device-name display, supported hardware, production firmware, end-to-end V1,
power/endurance, field/range, regulatory acceptance, or score credit. OT-114
remains accepted historical direct-radio evidence although its diagnostic image
is no longer installed. See [OT-115 evidence](../tests/hardware/OT-115-2026-08-21.md).
...
210,816-byte image with SHA-256
`A50B6F19C728CC8FE40256CF5786385BDA0F34AF35EA3BD65326A03CFF7D3E6D`.
Both booted receive-only with `ready=yes`; controlled structured frames passed
A→B and B→A at 17 and exactly 163 total wire bytes, ending at `rx=2`, `tx=2`,
and `armed=no` on each node. This is not the full OT-110 run: stress, measured
ceiling, rejection, latency, RSSI/SNR recording, restart persistence, EIRP,
regulatory acceptance, compatibility, and support remain open. Readiness,
counts, and progress values do not change. See [OT-112 evidence](../tests/hardware/OT-112-2026-08-21.md).
...
OT-106 promotes the accepted OT-101/OT-101A compact-footer implementation into the production UI component and links it into the Heltec V4 bench target. The target build uses the exact placeholder footer `BAT:--% GPS:-- BLE:<S/A/C/R/E>` with a blank five-column direction field because no live battery, GNSS, or LoRa-activity source is bound. Terminal BLE errors retain compact `BLE:E` precedence; startup-logo and explicit full-screen `SELF CHECK FAIL` behavior remain separate.
...
OT-109 admits exact host-only mbedTLS/PSA API/configuration evidence for five of the eight fixed operations through append-only `OTCAPIA0/v0`, canonical SHA-256 `fed7b009a97a60678b2dfbba23d933b974aa0fec46d0b460ac7eb221e91931dd` and raw SHA-256 `0311b8b264d264d4a005ac9be8531c06175521362ed54ac9f40bdef1fd7a5df0`. The generated and bound `OTCAPIOE0/v0` operation bundle is canonical `6a17a6f5a753a19d2d78d7cb6f0c757ef9791e0bf2e953e27afc3eccb04f27ed` / raw `ea85f548deee36ca34241747cdf567036febfb9eecd88d9e134d3383edf2379e`; `OTCAPI0/v2` candidate evidence is canonical `22975ac7fbd3c9faab1ae0c9fa952a58dc4a7a893de3cc74604182b3492fe1f8` / raw `67532e10704d02489b72a72ef55607743c00a5bd8504276750931b5d986f6155`. Two fresh configuration-only reproductions match the exact OT-107 sdkconfig; no candidate source was copied or compiled.

The five evidenced operations are X25519, SHA-256, HKDF-SHA256, and ChaCha20-Poly1305 encrypt/decrypt. Ed25519 sign/verify and Noise XK remain unavailable. This strict partial result is comparison-only and structurally nonselectable. Counts become `3/1/0`; only `direct_radio_mtu_phy_region_unresolved` remains, and readiness stays blocked. No import/build/benchmark, device/radio/key action, execution, selection, physical evidence, authority, or score is added. See [Decision 0050](decisions/0050-host-only-mbedtls-psa-api-configuration-admission.md), the [operation bundle](../tests/benchmarks/crypto/OT-109-OT005-MBEDTLS-PSA-API-CONFIG-OPERATION-EVIDENCE-V0.json), [candidate evidence](../tests/benchmarks/crypto/OT-109-OT005-MBEDTLS-PSA-API-CONFIG-EVIDENCE-V2.json), [admission](../tests/benchmarks/crypto/OT-109-OT005-MBEDTLS-PSA-API-CONFIG-ADMISSION-DELTA-V0.json), and [OT-109 evidence note](../tests/hardware/OT-109-2026-08-21.md).

OT-108 freezes append-only `OTCAC0/v1`, canonical SHA-256 `ccdb11e19031a4a01c717e30c172332c5e71ca79ee2b36b721277e55ca9a6c22` and raw SHA-256 `575e8747cdba643f2abb6f3252a62adbf3f12a9faaa46ca1d4bf4ce8bd9d23f3`, as the corrected per-candidate API/configuration acceptance boundary. Each candidate binds to its own OT-107 generated sdkconfig. Complete eight-operation evidence is required for structural selection eligibility; strict nonempty partial evidence is comparison-only, limited to evidenced operations, and nonselectable. Independent admission remains mandatory and all registries remain empty.

Counts remain `3/0/0`, OT-096 remains 5/8, the same two blockers remain, and readiness remains blocked. OT-108 changes no historical artifact or validation result and adds no API/configuration evidence, import/build/benchmark, device/radio/key action, selection, physical evidence, authority, or score. See [Decision 0049](decisions/0049-versioned-per-candidate-api-configuration-acceptance-contract.md) and [OT-108 evidence](../tests/hardware/OT-108-2026-08-21.md).
...
successor plan. OT-117 admits complete eight-of-eight libsodium API/configuration evidence and
OT-118 admits strict five-of-eight Monocypher comparison evidence. OT-119 then
independently admits the exact `OT-DEV-002` profile and completes phase 0. All three
