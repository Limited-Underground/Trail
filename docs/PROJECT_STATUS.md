...
OT-150 accepts the host-only deterministic successor to OT-149: candidate A/B and matched control A/B each complete fresh, initially absent, cache-disabled ESP-IDF v6.0.2 builds with fixed `PROJECT_VER=ot150-mbedtls-psa-v0`, 1,199/1,199 build steps, zero compiler warnings, and exact per-side reproduction. The canonical preparation freezes each side's strict six-role executable tuple and shared sdkconfig, bootloader, and partition identities. The admitted matched-resource result records candidate/control linked flash 245,466/145,834 bytes (`+99,632`) and static RAM 50,187/49,035 bytes (`+1,152`). Only a future candidate application write at `0x10000` may be separately authorized, and exact restoration must use the 500,944-byte OT-147 image with SHA-256 `f2a58414f82eed585ba90bf7671b06c8ebfaa82e8b23f6ac2093de95143b4e0e`. OT-150 grants no authority and adds no hardware, radio, selection, Phase 2 completion, field-readiness, or score claim. V1 remains exact 43.75%/displayed 44%. No website update is required because public capability, readiness, and completion remain unchanged. See [Decision 0086](decisions/0086-freeze-ot150-mbedtls-psa-executable-resource-bundle.md), [OT-150 evidence](../tests/hardware/OT-150-2026-08-27.md), [canonical preparation](../tests/benchmarks/crypto/OT-150-OT005-MBEDTLS-PSA-EXECUTABLE-RESOURCE-BUNDLE-PREPARATION-V0.json), and [matched-resource result](../tests/benchmarks/crypto/OT-150-OT005-MATCHED-RESOURCE-RESULT-V1.json).
