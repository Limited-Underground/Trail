...
The suite and all twenty map suites pass 100/100 focused repeats in the
complete 78-executable host matrix under strict C++17 warnings-as-errors.
...
permit input or reset/provision authority, so neither component can yet execute
an authorized domain mutation.
