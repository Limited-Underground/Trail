// OT-208: durable invitation target; unchanged OT-203 control and receipt framing.
#include <limits>
#include <sodium.h>
#include "nvs_flash.h"
#include "esp_timer.h"
...
extern "C" void app_main(){
 ...
 const bool passed=initialized&&ot_console_healthy()&&target::heltec_v4_invitation_eval::evaluate(entropy.random(),now_ms);
