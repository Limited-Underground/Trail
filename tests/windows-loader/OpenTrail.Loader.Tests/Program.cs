...
try
{
    ...
    Console.WriteLine(
        $"INFO: production Windows loader accepted {windowAcceptance.AcceptedResizeTransitions} shown resize transition");
    Console.WriteLine(
