...
import security_policy_receipt_restore_observation as stage
...
class Tests(unittest.TestCase):
    def setUp(self):
        ...
        self.image = stage.readback.ImageBinding(stage.readback.SYNC_CONTRACT,
            "heltec_v4_security_receipt_sync", "b" * 64)
    ...
    def test_capture_before_actual_full_restoration(self):
        ...
        captures = list((self.root / ".private").glob("ot203-receipt-*.bin"))
    ...
    def test_existing_capture_is_not_overwritten(self):
        path = self.root / ".private" / f"ot203-receipt-A-{'a' * 32}.bin"
    ...
    def test_close_failure_blocks_all_rom_and_disk_capture(self):
        ...
        self.assertFalse(list((self.root / ".private").glob("ot203-receipt-*.bin")))
