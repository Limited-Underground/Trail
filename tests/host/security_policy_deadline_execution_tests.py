"""Actual OT212 orchestration/authority/observation/restoration; synthetic storage only."""
from pathlib import Path
import copy,json,sys,tempfile,unittest
from unittest.mock import patch
ROOT=Path(__file__).resolve().parents[2]
sys.path.insert(0,str(ROOT/'tools'))
import security_policy_deadline_execution as x
...
class Tests(unittest.TestCase):
    ...
    def test_observation_failure_restoration_success(self):
        ...
        self.assertEqual(claim['schema'],'OT212-DEADLINE-OBSERVATION-CLAIM-1')
    ...
    def test_legacy_schema_and_authority_refused(self):
        for schema in ('OT188-GRANT-1','OT198-INPUT-EXECUTE-GRANT-1','OT196-STAGE-EXECUTE-GRANT-1','OT201-SYNC-EXECUTE-GRANT-1','OT210-INVITATION-EXECUTE-GRANT-1'):
