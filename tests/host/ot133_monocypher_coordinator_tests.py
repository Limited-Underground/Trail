#!/usr/bin/env python3
"""Focused host-only tests for the OT-133 restoration-safe coordinator."""
...
MODULE_PATH = ROOT / "tools" / "ot133_monocypher_coordinator.py"
SPEC = importlib.util.spec_from_file_location("ot133_coordinator_tests_module", MODULE_PATH)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("unable to load OT-133 coordinator")
coordinator = importlib.util.module_from_spec(SPEC)
sys.modules[SPEC.name] = coordinator
SPEC.loader.exec_module(coordinator)


BENCHMARK_PAYLOAD = b"ot133 benchmark fixture"
...
class Fixture:
    ...
    def __enter__(self):
        ...
        self.stack.enter_context(mock.patch.object(
            ...
            self.private / "ot133-monocypher-execution-journal.json",
        ))
        self.stack.enter_context(mock.patch.object(
            coordinator, "EXECUTION_RECEIPT_PATH",
            self.private / "ot133-monocypher-execution-receipt.json",
        ))
        self.stack.enter_context(mock.patch.object(
            coordinator, "RECOVERY_RECEIPT_PATH",
            self.private / "ot133-monocypher-recovery-receipt.json",
        ))
        self.stack.enter_context(mock.patch.object(
...
class Ot133CoordinatorTests(unittest.TestCase):
    ...
    def test_11_private_values_and_broad_write_surfaces_are_structurally_absent(self) -> None:
        ...
        self.assertIn("ot132_monocypher_protocol_runner.py", source)
        ...
        duplicate_config = coordinator.RunConfig(
            ...
            benchmark_path=Path("C:/placeholder/ot129_monocypher_protocol_bench.bin"),
