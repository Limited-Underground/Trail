...
MODULE_PATH = ROOT / "tools" / "ot140_monocypher_hardware_adapter.py"
SPEC = importlib.util.spec_from_file_location("ot140_hardware_adapter_tests", MODULE_PATH)
...
class AdapterTests(unittest.TestCase):
    ...
    def test_01_authority_gate_returns_exact_nonreusable_grant(self) -> None:
        gate = adapter.ExecutionAuthorityGate(
            ...
            Path("C:/private/ot139_monocypher_quiet_bench.bin"),
    ...
    def test_05_execute_requires_visual_confirmation_before_backend_creation(self) -> None:
        ...
        code, stdout, stderr = self._run_main(
            [
                "--port-a", PORT_A,
                "--port-b", PORT_B,
                "--benchmark-app", "C:/private/ot139_monocypher_quiet_bench.bin",
        ...
        self.assertEqual(stderr, "ERROR: OT-140 hardware operation failed\n")
    ...
    def test_06_preflight_cli_uses_one_backend_and_never_executes(self) -> None:
        ...
        self.assertEqual(stdout, "OK: OT-140 preflight reset completed on both nodes\n")
    ...
    def test_07_execute_cli_passes_same_backend_to_untouched_coordinator(self) -> None:
        ...
        self.assertEqual((code, stderr), (0, ""))
        self.assertEqual(stdout, "OK: OT-140 two-node attempt completed and restored\n")
        self.assertEqual(len(created), 1)
    ...
    def test_08_recovery_needs_no_benchmark_or_visual_flag(self) -> None:
        ...
        self.assertEqual((code, stderr), (0, ""))
        self.assertEqual(stdout, "OK: OT-140 recovery restored all touched nodes\n")
        ...
        with mock.patch.object(
            ...
            code, stdout, stderr = self._run_main(
                [
                    "--port-a", private,
                    "--port-b", PORT_B,
                    "--benchmark-app", f"C:/{private}/ot139_monocypher_quiet_bench.bin",
