#!/usr/bin/env python3
"""Adversarial host tests for the OT-162 one-attempt radio authority."""
...
TOOL_PATH = ROOT / "tools" / "ot162_noise_xk_radio_execution_authority.py"
SPEC = importlib.util.spec_from_file_location("ot162_authority_tests", TOOL_PATH)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("OT-162 authority tool unavailable")
...
class Fixture:
    def __init__(self) -> None:
        self.temporary = tempfile.TemporaryDirectory(prefix="ot162-authority-test-")
        ...
        self.benchmark_payload = b"ot162 exact benchmark fixture"
        self.restore_payload = b"ot162 exact Trail restoration fixture"
...
class AuthorityTests(unittest.TestCase):
    def test_01_exact_ot161_preparation_and_reset_contract_are_bound(self) -> None:
        ...
        self.assertEqual(preparation["schema"], "OT161NXBP0")
    ...
    def test_08_exclusive_output_never_overwrites(self) -> None:
        with tempfile.TemporaryDirectory(prefix="ot162-output-") as directory:
