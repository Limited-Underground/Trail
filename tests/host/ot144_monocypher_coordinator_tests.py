#!/usr/bin/env python3
"""Focused host-only tests for the OT-144 restoration-safe coordinator."""
...
MODULE_PATH = ROOT / "tools" / "ot144_monocypher_coordinator.py"
SPEC = importlib.util.spec_from_file_location("ot144_coordinator_tests_module", MODULE_PATH)
if SPEC is None or SPEC.loader is None:
    raise RuntimeError("unable to load OT-144 coordinator")
coordinator = importlib.util.module_from_spec(SPEC)
sys.modules[SPEC.name] = coordinator
SPEC.loader.exec_module(coordinator)


BENCHMARK_PAYLOAD = b"ot144 benchmark fixture"
...
class Fixture:
    ...
    def __enter__(self):
        ...
        self.stack.enter_context(mock.patch.object(
            ...
            self.private / "ot144-monocypher-execution-journal.json",
        ))
        self.stack.enter_context(mock.patch.object(
            coordinator, "EXECUTION_RECEIPT_PATH",
            self.private / "ot144-monocypher-execution-receipt.json",
        ))
        self.stack.enter_context(mock.patch.object(
            coordinator, "RECOVERY_RECEIPT_PATH",
            self.private / "ot144-monocypher-recovery-receipt.json",
        ))
        self.stack.enter_context(mock.patch.object(
...
class Ot144CoordinatorTests(unittest.TestCase):
    ...
    def test_11_private_values_and_broad_write_surfaces_are_structurally_absent(self) -> None:
        ...
        duplicate_config = coordinator.RunConfig(
            ...
            benchmark_path=Path("C:/placeholder/ot142_monocypher_corrected_bench.bin"),
