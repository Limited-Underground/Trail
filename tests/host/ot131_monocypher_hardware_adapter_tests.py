...
MODULE_PATH = ROOT / "tools" / "ot131_monocypher_hardware_adapter.py"
SPEC = importlib.util.spec_from_file_location("ot131_hardware_adapter_tests", MODULE_PATH)
...
class AdapterTests(unittest.TestCase):
    ...
    def test_05_execute_requires_visual_confirmation_before_backend_creation(self) -> None:
        ...
        self.assertEqual(stderr, "ERROR: OT-131 hardware operation failed\n")
    ...
    def test_06_preflight_cli_uses_one_backend_and_never_executes(self) -> None:
        ...
        self.assertEqual(stdout, "OK: OT-131 preflight reset completed on both nodes\n")
    ...
    def test_07_execute_cli_passes_same_backend_to_untouched_coordinator(self) -> None:
        ...
        self.assertEqual((code, stderr), (0, ""))
        self.assertEqual(stdout, "OK: OT-131 two-node attempt completed and restored\n")
        self.assertEqual(len(created), 1)
    ...
    def test_08_recovery_needs_no_benchmark_or_visual_flag(self) -> None:
        ...
        self.assertEqual((code, stderr), (0, ""))
        self.assertEqual(stdout, "OK: OT-131 recovery restored all touched nodes\n")
