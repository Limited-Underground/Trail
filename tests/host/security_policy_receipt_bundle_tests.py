...
spec=importlib.util.spec_from_file_location('bundle',ROOT/'tools/security_policy_receipt_bundle.py')
...
class BundleTests(unittest.TestCase):
    def test_new_image_contract_is_exact_and_immutable(self):
        ...
        self.assertEqual(image.target,'heltec_v4_security_receipt_sync')
    ...
    def test_frozen_decoder_cannot_be_reblessed(self):
        for name in ('tools/security_policy_receipt_readback.py','tools/security_policy_receipt_observation.py',
