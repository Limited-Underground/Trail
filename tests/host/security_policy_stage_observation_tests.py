...
import security_policy_stage_observation as stage
import security_policy_stage_readback_tests as fixtures
...
class Tests(unittest.TestCase):
    ...
    def test_capture_before_actual_full_restoration(self):
        ...
        captures = list((self.root / ".private").glob("ot195-stage-*.bin"))
    ...
    def test_existing_capture_is_not_overwritten(self):
        path = self.root / ".private" / f"ot195-stage-A-{'a' * 32}.bin"
    ...
    def test_close_failure_blocks_all_rom_and_disk_capture(self):
        ...
        self.assertFalse(list((self.root / ".private").glob("ot195-stage-*.bin")))
